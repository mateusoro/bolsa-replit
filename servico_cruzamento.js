                                            ...
                                            for (var vv5_2 of estrategias[4].vs2) {
                                                ...
                                                for (var vv6_1 of estrategias[5].vs1) {
                                                    ...
                                                    for (var vv6_2 of estrategias[5].vs2) {
                                                        ...
                                                        for (var vv7_1 of estrategias[5].vs1) {

                                                            for (var vv7_2 of estrategias[5].vs2) {

                                                                var longa_maior7 = await escolher_estrategia_tipo(petr4, estrategias, 5, vv6_1, vv6_2, longa_maior5);

                                                                for (var vv8_1 of estrategias[5].vs1) {

                                                                    for (var vv8_2 of estrategias[5].vs2) {

                                                                        var longa_maior8 = await escolher_estrategia_tipo(petr4, estrategias, 5, vv6_1, vv6_2, longa_maior5);

                                                                        for (var vv9_1 of estrategias[5].vs1) {

                                                                            for (var vv9_2 of estrategias[5].vs2) {

                                                                                var longa_maior9 = await escolher_estrategia_tipo(petr4, estrategias, 5, vv6_1, vv6_2, longa_maior5);

                                                                                for (var vv10_1 of estrategias[5].vs1) {

                                                                                    for (var vv10_2 of estrategias[5].vs2) {

                                                                                        var longa_maior10 = await escolher_estrategia_tipo(petr4, estrategias, 5, vv6_1, vv6_2, longa_maior5);
