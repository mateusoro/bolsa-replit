...
async function escolher_indicador(acao, indicador, v) {
    ...
    if (indicador == 'di_plus') {
        resultado = await di_plus(acao, v);
    }
    return resultado;
...
function sinal(lista_curta, parametro_fixo, lista_longa, operador) {
    ...
    var lista_retorno = [];
    var lista_tendencia = [];
    var lista_cruzamento = [];

    for (var a in lista_curta) {
        var novo_parametro = parametro_fixo;
        var novo_parametro_anterior = parametro_fixo;
        ...
        if (lista_curta[a - 1] && lista_curta[a - 2]) {
            ...
            if (lista_curta[a] > novo_parametro && lista_curta[a-1] > novo_parametro_anterior && lista_curta[a - 2] < novo_parametro_anterior2) { cruzamento = "Cima"; }
            if (lista_curta[a-1] > novo_parametro_anterior && lista_curta[a - 2] < novo_parametro_anterior2) { cruzamento = "Cima"; }
                                            ...
                                            for (var vv5_2 of estrategias[4].vs2) {
                                                ...
                                                for (var vv6_1 of estrategias[5].vs1) {
                                                    ...
                                                    for (var vv6_2 of estrategias[5].vs2) {
                                                        ...
                                                        for (var vv7_1 of estrategias[6].vs1) {

                                                            for (var vv7_2 of estrategias[6].vs2) {

                                                                var longa_maior7 = await escolher_estrategia_tipo(petr4, estrategias, 6, vv7_1, vv7_2, longa_maior6);

                                                                for (var vv8_1 of estrategias[7].vs1) {

                                                                    for (var vv8_2 of estrategias[7].vs2) {

                                                                        var longa_maior8 = await escolher_estrategia_tipo(petr4, estrategias, 7, vv8_1, vv8_2, longa_maior7);

                                                                        for (var vv9_1 of estrategias[8].vs1) {

                                                                            for (var vv9_2 of estrategias[8].vs2) {

                                                                                var longa_maior9 = await escolher_estrategia_tipo(petr4, estrategias, 8, vv9_1, vv9_2, longa_maior8);

                                                                                for (var vv10_1 of estrategias[9].vs1) {

                                                                                    for (var vv10_2 of estrategias[9].vs2) {

                                                                                        var longa_maior10 = await escolher_estrategia_tipo(petr4, estrategias, 9, vv10_1, vv10_2, longa_maior9);
                                                                                        ...
                                                                                        for (var vv_stop of variavel_stop) {
                                                                                            ...
                                                                                            if (longa_maior10) {
                                                                                                ...
                                                                                                const estrategia = crosser(petr4, estrategias, sto);
