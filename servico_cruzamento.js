...
async function escolher_estrategia_tipo(acao, estra, index, v1, v2, longa_maior_anterior) {
    ...
    if (estra[index]) {
        ...
        if (estra[index].tipo == 'Compra' || estra[index].tipo == 'Venda') {
            ...
            estra[index].sinal = sinal(estra[index].indicador_valores, v2, null, estra[index].operador)[0];
        ...
        if (estra[index].tipo == 'Crosser') {
            ...
            estra[index].sinal = sinal(estra[index].indicador_valores_compra, 0, estra[index].indicador_valores_venda, estra[index].operador);
