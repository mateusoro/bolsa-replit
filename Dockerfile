...
RUN sudo apt-get install pstree
...
RUN sudo rclone sync rclone:/baskup_code_server /home/coder/ -vv --exclude="**node_modules/**" --exclude="**\.npm/**" --exclude="**\.npm/**" --exclude="**\.cache/**"
